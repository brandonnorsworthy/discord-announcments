...
public class DiscordAnnouncementsPlugin extends Plugin
{
	...
	{
		log.info("Discord Announcements started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Discord Announcements stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Discord Announcements says " + config.greeting(), null);
		}
	}
